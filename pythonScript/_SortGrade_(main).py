...
#print('argument num2 ', sys.argv[1])
...
imgname = filenamepath
path = os.path.join(newstrdir,imgname)

image = cv2.imread(imgname)

path = gSect.save_qSect(imgname,newstrdir)#this is to create directory

gSect.divideSection(image,path)#input image and it will be deivided into small image
